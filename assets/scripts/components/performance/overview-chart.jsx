        ...
        MG.data_graphic({
            ...
            mouseover: function(d, i) {
                ...
                d.values.forEach(function(val, index) {
                    ...
                    l_span.text(' ');
                    var no_days = d.values[index - 1]
                        ? (val.value - d.values[index - 1].value).toFixed(0)
                        : val.value.toFixed(0);
                    l_span.text(
                        '— ' +
                            _this.props.translation.overview.labels[val.line_id - 1] +
                            ' : ' +
                            no_days
                    );
                    D3.select('#region_performance_total_trans').text(
                        format(val.date) + ': ' + val.total_trans
                    );
                });
            ...
            <div className="pure-g">
                <div className="pure-u-6-24">
                    ...
                    <p>
                        ...
                        <span
                            title={
                                this.props.translation && this.props.translation.overview.tooltip
                            }
                            className="pe-7s-info"
                        />
                    </p>
                    <div className="legend region_legend" />
                    <div>
                        {this.props.translation && this.props.translation.total_trans}{' '}
                        <span id="region_performance_total_trans" />
                    </div>
                </div>
