...
module.exports = {
    ...
    performance: {
        ...
        discrete:{
            sub_heading: {
                '1' : 'आपकी पंचायत/प्रखंड/जनपद',
                '2' : 'का प्रदर्शन'
            },
            subtitle: {
                $filter: 'role',
                block: 'आपकी पंचायत में मज़दूरी भुगतान की प्रक्रिया के हर एक पड़ाव में लगा औसत समय',
                district: 'आपके पंचायत/प्रखंड/जनपद में मज़दूरी भुगतान की प्रक्रिया के हर एक पड़ाव में लगा औसत समय',
            ...
            panchayat_chart_placeholder: 'भुगतान के प्रदर्शन को देखने के लिए एक पंचायत या ्रखंड/जनपद का चयन करें',
        }
    },
    musters: {
        current: {
