        ...
        block: {
            ...
            indic_details: {
                ...
                content: [
                    ...
                    {
                        indic_name:'पेयडेश पर डेटा अपडेट कैसे होता है?',
                        indic_text:'पेयडेश पर ग्राम पंचायत स्तर का मस्टर रोल डेटा दिखता है, जो हमें राष्ट्रीय सूचना विज्ञान केंद्र, एम.ओ.आर.डी. से दिया जाता है| पेयडेश पर डेटा दिन में एक बार एन.आए. सी. से नये डेटा के साथ अपडेट होता है, सुबह आठ से दस बजे के बीच में| होम स्क्रीन पर प्रदर्शित टाइम स्टेम्प आपको डेटा अपडेट होने का सही दिनांक और समय बताएगा| डेटा के अपडेट होने के लिए आपको दिन में एक बार इंटरनेट कनेक्षन की ज़रूरत होगी|'
                    }
                ]
            }
        },
