        ...
        sequelize.query(queryString, {
			...
			var data = D3.nest()
			    ...
			    .rollup(function(v) {
			        return {
			            'metric': v[0].metric,
			            'metric_label': v[0].metric_label,
			            'comparisons': v.filter(function(d) { return d.type==='comparison'; })
			            	.map(function(d) {
			                return {
			            ...
			            'filters': 
			            	D3.nest()
			            		.key(function(d) { return d.filter_comparison; })
			            		.rollup(function(w) {
			            			return {
			                    ...
			                    .entries(v.filter(function(d) { return d.type==='filter'; }))
			                    .map(function(d) {
			                    	return d.values;
			                    })
			        };
